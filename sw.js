const CACHE='kokoriko-v2';
const ASSETS=['./','./index.html','./menu.html','./a-propos.html','./contact.html','./panier.html','./styles.css','./js/app.js','./js/menuData.js','./manifest.json','./assets/icon-192.png','./assets/icon-512.png'];
